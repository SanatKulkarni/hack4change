...
const Testimonial = () => {
    const testimonials = [
        {id: 1,title: "Raj, Small Business Owner",description: "“The real-time tracking and 24/7 support were game changers for us. Highly recommend GemPermit to any new entrepreneur.”", image: "/src/assets/testimonial.png"},
        {id: 2,title: "Anjali, Startup Founder",description: "“GemPermit made the licensing process so simple! I was able to focus on growing my business instead of dealing with paperwork.”", image: "/src/assets/testimonial.png"},
        {id: 3,title: "Priya, Entrepreneur",description: "“GemPermit streamlined the entire licensing process for us. The real-time updates and 24/7 support were invaluable.”", image: "/src/assets/testimonial.png"},
    ]
  return (
